...
uv tool install --managed-python -p "%PYTHON_VERSION%" --no-build --upgrade "%PACKAGE_NAME%"
if errorlevel 1 (
...
uvx --managed-python -p "%PYTHON_VERSION%" --no-build %PACKAGE_NAME% %COMMANDLINE_ARGS%
pause
